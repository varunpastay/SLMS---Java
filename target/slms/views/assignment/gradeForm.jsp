  ...
  <div class="col-lg-6">
    ...
    <div class="card shadow-sm mb-3">
      <div class="card-body">
        ...
        <p class="mb-1"><strong>Assignment:</strong> ${submission.assignmentTitle}</p>
        <p class="mb-2"><strong>Max Marks:</strong> <span class="badge bg-secondary fs-6">${assignment.maxMarks}</span></p>
        ...
        <form action="${ctx}/submission" method="post">
          ...
          <div class="mb-3">
            <label class="form-label fw-semibold">
              Marks Obtained <span class="text-muted small">(out of ${assignment.maxMarks})</span>
            </label>
            <input type="number" name="marks" class="form-control" step="0.01" min="0"
                   max="${assignment.maxMarks}" value="${submission.marksObtained}" required/>
          </div>
          <div class="mb-3">
